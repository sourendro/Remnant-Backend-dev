...
<head>
    ...
    <title>Remnant | Admin Login</title>
</head>
<body>
    <div class="container">
        <div class="login-box">
                    ...
                    <form method="POST" action="{{ url('/login-action')}}" autocomplete="off">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 login-btm login-button">
                                <button type="submit" class="btn btn-outline-primary hvr-float-shadow">LOGIN</button>
                            </div>
                            <div class="col-lg-12">
                                <a href="{{ url('/forget-password')}}" class="forgot-password"><h6>Forgot Password ?</h6></a>
                            </div>
                        </div>
                    </form> 
                </div>
